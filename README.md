...
- **[近代化版 UnLhaRe 1.0.1](UnLhaRe/README.md)**: Rust API、UTF-8 C API、Windows .NET 10向けNuGet `Kagayoi.UnLhaRe`、CLIで一覧・検査・展開・新規作成を提供します。32bitは対象外です。[専用リリースページ](https://github.com/1llum1n4t1s/UnLhaRe/releases/tag/unlhare-v1.0.1)から対象OS・CPUのパッケージを選択し、.NETアプリは[C#バインディング](UnLhaRe/bindings/dotnet/README.md)を参照してください。
