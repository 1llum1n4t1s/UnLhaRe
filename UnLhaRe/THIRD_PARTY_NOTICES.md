...
公開ソース: https://crates.io/crates/delharc / https://crates.io/crates/oxiarc-lzhuf 。その他のパッケージも同名のcrates.ioページとCargo registryから対応版を取得できます。書庫の比較用に用いる原版UNLHA32.DLLはこの近代化版へ同梱しません。
